...
It's all based on standard <abbr title="Python currently supported versions, 3.8.1 and above.">modern **Python**</abbr> type annotations. No new syntax to learn. Just standard modern Python.
