...
class SQLModelMetaclass(ModelMetaclass, DeclarativeMeta):
    ...
    def __new__(
        ...
        **kwargs: Any,
        ...
        has_custom_registry = "registry" in kwargs or (
            "model_config" in class_dict and "registry" in class_dict["model_config"]
        )
        if has_custom_registry:
            config_registry = kwargs.get("registry", Undefined)
            if config_registry is Undefined:
                config_registry = class_dict["model_config"].get("registry", Undefined)
